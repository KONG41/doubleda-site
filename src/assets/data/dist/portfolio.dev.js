...
var allPortfolio = [{
  ...
  project_type: "System, Website",
  solution: ["WordPress installation", " Website Design", " WooCommerce Integration", "  Marketing Email System", "SEO friendly"],
  tech_tools: ["WordPress", " HTML, CSS", "mySQL", "cPanel", " Elementator"],
  img: []
}, {
  ...
  project_type: "System, Website",
  solution: ["Back-end (Operation System)", " Website Design", "Report posting system", "Bond Calculator Integration", "SEO friendly"],
  tech_tools: ["JavaScript", "HTML, CSS", "mySQL", " cPanel", "PHP"],
  img: []
}, {
  ...
  service_package: ["Front-end & Back-end", "Booking System", "Automatic Ticketing", "Travel Planner & Alert function", "Admin & Local Agency System"],
  solution: [],
  tech_tools: [],
  img: []
}, {
  ...
  tech_tools: [],
  img: [],
  service_package: ["Branding & Concept", "Interior Design & Construction"]
}, {
  ...
  tech_tools: [],
  img: [],
  service_package: ["Branding & Concept", "Interior Design & Construction", "Menu & Content Design", "SEO & SNS Marketing", "Brochure & Leaflet Design"]
}, {
  ...
  project_type: "System, Website",
  solution: ["Back-end (Operation System)", "Website Design", "Booking System Integration", "Finance System", "SEO friendly", "Graphic Design (Logo, Photo, Video, etc)"],
  tech_tools: ["JavaScript", "HTML, CSS", "MongoDB", "NodeJS", "API, Quick Service"],
  img: []
}];
