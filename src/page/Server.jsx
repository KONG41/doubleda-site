            ...
            <div className="row">
              <div className="col-12">
                <div className="banner_content server-content">
                  <h5 className="text-uppercase sub-title server-sub-title">server</h5>
                  <h1 className="text-uppercase main-title server-main-title">Hosting & <br/>Maintenance</h1>
                  <p className=" text-uppercase desc-title server-desc-title">We make sure your website is fast, secure & always up so your visitors & search engines trust you. </p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="server-content feature row">
            ...
            <div className="feature-item col-xl-4 col-md-6 col-sm-12">
              <div className="feature-box">
                ...
                <p>Website (Cloud, Dedicated) & WordPress Hosting, Domian Registration & Management</p>
              </div>
            </div> 
        </div>
      </section>
        ...
        <div className="server-content hosting">
            <div className="row hosting-header">
              <div className="col-xl-6 col-md-6 col-sm-12">
                  <h1>Hosting Plan</h1>
                  <p>We provide hosting services for businesses of all sizes. Depends on spec required for your business, we recommend the most suitable hosting plan and guarantee the fast and secure hosting.</p>
              </div>
            </div>
